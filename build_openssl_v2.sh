#!/bin/sh
# from https://stackoverflow.com/questions/52717228/how-to-compile-openssl-1-1-1-for-android
# another script: https://github.com/sqlcipher/android-database-sqlcipher/blob/master/android-database-sqlcipher/build-openssl-libraries.sh

# ANDROID_NDK=/Users/dengziyue/Library/Android/ndk/android-ndk-r17c
ANDROID_NDK=/Users/dengziyue/Library/Android/sdk/ndk-bundle #ndk-20
...
sed -i '' 's/.*-mandroid.*//' Configurations/15-android.conf #fix on mac os
patch -p1 -N <<EOP
...
build_the_thing() {
    ...
    TOOLCHAIN=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64 #fix for mac os
