...
#################### config NDK version#####################
function load_ndk_20 {
  export ANDROID_NDK_ROOT=/Users/dengziyue/Library/Android/sdk/ndk-bundle  
}

function load_ndk_12b {
  export ANDROID_NDK_ROOT=/Users/dengziyue/Library/Android/ndk/android-ndk-r12b
}

function load_ndk_17c {
...
# add by dzy
# ANDROID_TOOLCHAIN=$ANDROID_NDK_ROOT/toolchains/android-toolchain-arm/bin
...
do
  ...
  if [ ! -e "$ANDROID_TOOLCHAIN/$tool" ]; then
    echo "Error: Failed to find $ANDROID_TOOLCHAIN/$tool. Please edit this script."
...
# 2. you should ln $ANDROID_SYSROOT/usr/lib/crtbegin_so.o crtend_so.o 
